---
name: mermaid
description: Generate diagrams and flowcharts from mermaid definitions using the mermaid-cli (mmdc). Use when creating diagrams, flowcharts, sequence diagrams, Gantt charts, or converting mermaid code to SVG/PNG/PDF. Also use when processing markdown files containing mermaid code blocks. Supports themes, custom CSS, and various output formats. Mermaid supports 20+ diagram types including flowcharts, sequence diagrams, class diagrams, state diagrams, entity relationship diagrams, user journeys, Gantt charts, pie charts, quadrant charts, requirement diagrams, GitGraph, C4 diagrams, mindmaps, timelines, ZenUML, Sankey diagrams, XY charts, block diagrams, packet diagrams, Kanban boards, architecture diagrams, radar charts, and treemaps.
---
